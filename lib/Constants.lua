return {
	...
	-- Name of particle and basepart storage in PlayerGui and Workspace respectively:
	SPARKS_MAIN_FOLDER = "SparksParticles";

	PARTFOLDER_NAME_TEMPLATE = "sparks_%05d"; -- Name format of storage of parts (name of copy of script.Template)
	...
	SEGMENT_THROTTLING_DISTANCE = 100; -- Distance at which the number of segments per arc will start throttling

	MAX_DISTANCE = 1000; -- Distance from camera after which no further updating of effect will occur
	...
	SEGMENT_MINMAX_RATIO = 24; -- Range of arc segment length, as ratio max:min, ratio is actually this + 1, so 25
	...
	RARE_CHANCE_DURATION_MULT = 3; -- How much longer a rare fat arc lasts compared to the typical duration range
